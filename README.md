...
The choice of the algorithm and of the variable on which we perform evaluation-interpolation can be made by executing `algebraic_single(P , k, var, algorithm, variable)`.
